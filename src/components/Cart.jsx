...
const Cart = ({courseName, count, remaining}) => {
    return (
        <div className="w-1/4 border rounded-xl shadow-lg p-6 space-y-4">
            <h3 className="text-[#2F80ED] text-xl font-bold leading-8">Credit Hour Remaining: {remaining}hr</h3>
            <hr />
            ...
            <hr />
            <p className="text-[#1C1B1BCC] font-medium">Total Credit Hour: {count}hr </p>
            <hr />
        </div>
    );
};
